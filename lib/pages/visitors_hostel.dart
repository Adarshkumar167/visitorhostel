...
import 'package:visitor_hostel/pages/visitors_hostel_caretaker.dart';
import 'package:visitor_hostel/pages/visitor_hostels_incharge.dart';

class VisitorHostel extends StatefulWidget {
  const VisitorHostel({super.key});
                ...
                children: <Widget>[
                              ...
                              child: Column(
                                children: <Widget>[
                                  ...
                                  GestureDetector(
                                    ...
                                    child: const Text("Cancellation Requests"),
                                  ),
                                  const SizedBox(height: 9.0),
                                  const Divider(
                                    thickness: 1.0,
                                  ...
                                  GestureDetector(
                                    ...
                                    child: const Text("Active Bookings"),
                                  ),
                                  const SizedBox(height: 9.0),
                                  const Divider(
                                    thickness: 1.0,
                  ...
                  SizedBox(
                    ...
                    child: MaterialButton(
                        ...
                        child: const Text('Incharge Login',
                            style: TextStyle(fontSize: 18.0))),
                  ),
                ],
              ),
